...
:::info
Double check that the bot has administrator permissions. If that's all good, then you're ready to move onto [configuring the bot](/docs/setup/configuration)! 
:::