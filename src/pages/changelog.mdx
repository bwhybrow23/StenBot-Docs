---
title: Changelog
description: All changes made to StenBot will be documented here.
---

# Changelog

All changes made to StenBot will be documented here., following the [Keep a Changelog](https://keepachangelog.com/en/1.0.0/) format. The changelogs from Version 1.2.0 can also be viewed on the [Discord server](https://discord.benwhybrow.com) in the [#stenbot-changelog](https://discord.com/channels/455782308293771264/624321343420235826) channel.
...
-  Update my Discord tag in messages
***
## 2.2.2 - 2022-01-04
### Changed
...
### Added
- `dev` branch added
- Interactive `report` command added
### Changed
- Switched to using bot.logger over console.log
- Renamed functions
...
## 1.4.1 - 2020-08-22
### Changed
- Upgraded verification system to Discord v12
***
## 1.4.0 - 2020-08-22
### Changed
